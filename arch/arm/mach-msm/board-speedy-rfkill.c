...
static uint32_t speedy_bt_init_table[] = {
	...
	GPIO_CFG(SPEEDY_GPIO_BT_UART1_RTS, /* BT_RTS */
				1,
				GPIO_CFG_OUTPUT,
				GPIO_CFG_NO_PULL,
				GPIO_CFG_8MA),
	GPIO_CFG(SPEEDY_GPIO_BT_UART1_CTS, /* BT_CTS */
				1,
				GPIO_CFG_INPUT,
				GPIO_CFG_PULL_UP,
				GPIO_CFG_8MA),
	GPIO_CFG(SPEEDY_GPIO_BT_UART1_RX, /* BT_RX */
				1,
				GPIO_CFG_INPUT,
				GPIO_CFG_PULL_UP,
				GPIO_CFG_8MA),
	GPIO_CFG(SPEEDY_GPIO_BT_UART1_TX, /* BT_TX */
				1,
				GPIO_CFG_OUTPUT,
				GPIO_CFG_NO_PULL,
				GPIO_CFG_8MA),

	GPIO_CFG(SPEEDY_GPIO_BT_RESET_N, /* BT_RESET_N */
				0,
				GPIO_CFG_OUTPUT,
				GPIO_CFG_NO_PULL,
				GPIO_CFG_4MA),
	GPIO_CFG(SPEEDY_GPIO_BT_SHUTDOWN_N, /* BT_SHUTDOWN_N */
				0,
				GPIO_CFG_OUTPUT,
				GPIO_CFG_NO_PULL,
				GPIO_CFG_4MA),

	GPIO_CFG(SPEEDY_GPIO_BT_HOST_WAKE, /* BT_HOST_WAKE */
				0,
				GPIO_CFG_INPUT,
				GPIO_CFG_PULL_DOWN,
				GPIO_CFG_4MA),
	GPIO_CFG(SPEEDY_GPIO_BT_CHIP_WAKE, /* BT_CHIP_WAKE */
				0,
				GPIO_CFG_OUTPUT,
				GPIO_CFG_NO_PULL,
				GPIO_CFG_4MA),
...
static uint32_t speedy_bt_on_table[] = {
	...
	/* BT_RTS */
	GPIO_CFG(SPEEDY_GPIO_BT_UART1_RTS,
				1,
				GPIO_CFG_OUTPUT,
				GPIO_CFG_NO_PULL,
				GPIO_CFG_8MA),
	/* BT_CTS */
	GPIO_CFG(SPEEDY_GPIO_BT_UART1_CTS,
				1,
				GPIO_CFG_INPUT,
				GPIO_CFG_PULL_UP,
				GPIO_CFG_8MA),
	/* BT_RX */
	GPIO_CFG(SPEEDY_GPIO_BT_UART1_RX,
				1,
				GPIO_CFG_INPUT,
				GPIO_CFG_PULL_UP,
				GPIO_CFG_8MA),
	/* BT_TX */
	GPIO_CFG(SPEEDY_GPIO_BT_UART1_TX,
				1,
				GPIO_CFG_OUTPUT,
				GPIO_CFG_NO_PULL,
				GPIO_CFG_8MA),
	...
	/* BT_HOST_WAKE */
	GPIO_CFG(SPEEDY_GPIO_BT_HOST_WAKE,
				0,
				GPIO_CFG_INPUT,
				GPIO_CFG_PULL_DOWN,
				GPIO_CFG_4MA),
	/* BT_CHIP_WAKE */
	GPIO_CFG(SPEEDY_GPIO_BT_CHIP_WAKE,
				0,
				GPIO_CFG_OUTPUT,
				GPIO_CFG_NO_PULL,
				GPIO_CFG_4MA),
	/* BT_RESET_N */
	GPIO_CFG(SPEEDY_GPIO_BT_RESET_N,
				0,
				GPIO_CFG_OUTPUT,
				GPIO_CFG_NO_PULL,
				GPIO_CFG_4MA),
	/* BT_SHUTDOWN_N */
	GPIO_CFG(SPEEDY_GPIO_BT_SHUTDOWN_N,
				0,
				GPIO_CFG_OUTPUT,
				GPIO_CFG_NO_PULL,
				GPIO_CFG_4MA),
...
static void speedy_config_bt_init(void)
{
	...
	/* BT_RESET_N */
	gpio_set_value(SPEEDY_GPIO_BT_RESET_N, 0);
	mdelay(1);

	/* BT_SHUTDOWN_N */
	gpio_set_value(SPEEDY_GPIO_BT_SHUTDOWN_N, 0);
	mdelay(5);

	/* BT_SHUTDOWN_N */
	gpio_set_value(SPEEDY_GPIO_BT_SHUTDOWN_N, 1);
	mdelay(1);

	/* BT_RESET_N */
	gpio_set_value(SPEEDY_GPIO_BT_RESET_N, 1);
	mdelay(2);
#if 0
...
static void speedy_config_bt_off(void)
{
	...
	/* BT_RTS */
	gpio_set_value(SPEEDY_GPIO_BT_UART1_RTS, 1);

	/* BT_CTS */

	/* BT_TX */
	gpio_set_value(SPEEDY_GPIO_BT_UART1_TX, 1);
	...
	/* BT_CHIP_WAKE */
	gpio_set_value(SPEEDY_GPIO_BT_CHIP_WAKE, 0);
