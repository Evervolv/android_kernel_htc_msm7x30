...
#endif
	pm8xxx_gpio_config(PM8058_GPIO_PM_TO_SYS(SPEEDY_AUD_HANDSET_ENO), &audio_pwr);
	pm8xxx_gpio_config(PM8058_GPIO_PM_TO_SYS(SPEEDY_AUD_SPK_ENO), &tpa2051_pwr);
